# NexLink Theme Specification

> **Purpose:** This document defines the official NexLink design system. Use this as a reference when building any NL product to ensure visual consistency across all platforms.
...
| Name | Hex | Usage |
|------|-----|-------|
| Primary | `#0a51c2` | Main brand color, buttons, links, accents |
| Primary Light | `#3b7de6` | Hover states, highlights, success indicators |
| Primary Dark | `#083d94` | Active states, pressed buttons |

### Secondary Colors (Green)

| Name | Hex | Usage |
|------|-----|-------|
| Secondary | `#2bc56b` | Accent elements, special features, badges |
| Secondary Light | `#4ed88a` | Hover states, highlights |
| Secondary Dark | `#22a057` | Active states, pressed buttons |

### Accent Colors (Teal)

| Name | Hex | Usage |
|------|-----|-------|
| Accent | `#18a099` | Accent highlights, tertiary actions, decorative elements |
| Accent Light | `#1fc2b9` | Hover states, highlights |
| Accent Dark | `#138580` | Active states, pressed buttons |
...
```
Primary:    #0a51c2 (Emerald-700)
Secondary:  #2bc56b (Purple-500)
Background: #1A1A1E
Paper:      #16181D
Text:       #E5E7EB
Muted:      #9CA3AF
...
**Apply this theme consistently across all NexLink products for brand unity.**
